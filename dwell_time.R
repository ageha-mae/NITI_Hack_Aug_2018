...
import_mar <- read.csv(file="C:\\Users\\aditi\\Documents\\PortDwellTime\\JNPT_Port_Operations_March_2018_IMPORT.csv",
                       header=T, stringsAsFactors = F)
export_mar <- read.csv(file="C:\\Users\\aditi\\Documents\\PortDwellTime\\JNPT_Port_Operations_March_2018_EXPORT.csv",
                       header=T, stringsAsFactors = F)

import_apr <- read.csv(file="C:\\Users\\aditi\\Documents\\PortDwellTime\\JNPT_Port_Operations_April_2018_IMPORT.csv",
                       header=T, stringsAsFactors = F)
export_apr <- read.csv(file="C:\\Users\\aditi\\Documents\\PortDwellTime\\JNPT_Port_Operations_April_2018_EXPORT.csv",
                       header=T, stringsAsFactors = F)

import_may <- read.csv(file="C:\\Users\\aditi\\Documents\\PortDwellTime\\JNPT_Port_Operations_May_2018_IMPORT.csv",
                       header=T, stringsAsFactors = F)
export_may <- read.csv(file="C:\\Users\\aditi\\Documents\\PortDwellTime\\JNPT_Port_Operations_May_2018_EXPORT.csv",
                       header=T, stringsAsFactors = F)
